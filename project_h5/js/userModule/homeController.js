...
homeController.controller('homeController', function($scope, $mdSidenav) {
  ...
  $('.mainContent').css('filter','blur(5px)');
    $mdDialog.show({
      ...
      template:'<md-dialog ng-cloak style="padding:0;max-height: 100%;"><md-dialog-content style="padding:0;"><div class="swiper-container" style="width:500px;height:700px;"><div class="swiper-wrapper" id="previewPage">'+$('#editPage').html()+'</div></div></md-dialog-content><md-dialog-actions layout="row"></md-dialog-actions></md-dialog><script>var swiper = new Swiper(".swiper-container",{pagination:".swiper-pagination",paginationClickable:true,direction:"vertical"})</script>',
...
function DialogController($scope, $mdDialog) {
 ...
 $('#textSelected').draggable({'position':'absolute'});
      $('div.swiper-slide-active div').on('click',function(event){
            ...
            var type = $(this).data('type') == 'text' ?$(this).attr('id','textSelected'):'';
