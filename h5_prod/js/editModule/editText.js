		...
		stop:function (){
		    ...
		    var l = ( 100 * parseFloat($(this).css("left")) / parseFloat($(this).parent().css("width")) )+ "%" ;
			     ...
			     $(this).css("top" , t);
			      ...
			      var w = ( 100 * parseFloat($(this).width()) / parseFloat($('.isEdit').outerWidth()) )+ "%" ;
			     var h = ( 100 * parseFloat($(this).height()) / parseFloat($('.isEdit').outerHeight()) )+ "%" ;
			     $(this).css("width" , w);
			     $(this).css("height" , h);
